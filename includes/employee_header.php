...
if (empty(trim($sidebarFullName))) $sidebarFullName = 'Employee User';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4 d-flex flex-column">
    <a href="../Employee/employee_dashboard.php" class="brand-link border-bottom-0">
    ...
    <div class="sidebar flex-grow-1 d-flex flex-column">
      ...
      <div class="user-panel mt-2 pb-3 pt-3 mb-3 d-flex align-items-center justify-content-center shadow-sm" style="background-color: #454d55; border-radius: 8px; margin-left: 4px; margin-right: 4px;">
        ...
        <div class="info d-flex flex-column align-items-start pl-1" style="overflow: hidden; max-width: 160px;">
            ...
            <span class="badge bg-info mt-1" style="font-size: 0.7rem; font-weight: normal; padding: 3px 6px;">
                <i class="fas fa-briefcase mr-1" style="font-size: 0.6rem;"></i> <?php echo htmlspecialchars($sidebarRole); ?>
            </span>
        </div>
      </div>
      ...
      <nav class="mt-2 flex-grow-1">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu">
          ...
          <li class="nav-item">
            <a href="../Employee/employee_payroll.php" class="nav-link">
              <i class="nav-icon fas fa-wallet"></i>
              <p>Payroll</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="../Employee/employee_request.php" class="nav-link">
