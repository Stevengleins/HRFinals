...
$display_middle = !empty($hrProfile['middle_name']) ? $hrProfile['middle_name'] : '';
$display_last  = !empty($hrProfile['last_name']) ? $hrProfile['last_name'] : $hrProfile['u_last'];
$display_suffix = !empty($hrProfile['suffix']) ? $hrProfile['suffix'] : '';
...
$shift_start = !empty($hrProfile['shift_start']) ? $hrProfile['shift_start'] : '08:00:00';
$shift_end = !empty($hrProfile['shift_end']) ? $hrProfile['shift_end'] : '17:00:00';
...
if (isset($_POST['update_profile'])) {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if ($checkStmt->get_result()->num_rows > 0) {
            ...
            $hashed_password = $hrProfile['u_password'];
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow-sm border-0" style="border-radius: 8px; overflow: hidden;">
              ...
              <form id="editProfileForm" method="POST" action="hr_edit_profile.php" novalidate>
                <div class="card-body bg-light">

                  <div class="alert alert-secondary shadow-sm mb-4" style="border-left: 4px solid #6c757d;">
                      <i class="fas fa-info-circle mr-2"></i> <strong>Note:</strong> Your name, system role, and shift are locked. If you need to modify these, please contact your System Administrator.
                  </div>
