...
$rawImagePath = trim((string)$hrProfile['profile_image']);
        ...
        <div class="col-md-8">
            <div class="card shadow-sm border-0" style="border-radius: 8px; overflow: hidden;">
              ...
              <div class="card-footer bg-white text-right border-top-0 py-3">
                <a href="hr_dashboard.php" class="btn btn-outline-secondary shadow-sm mr-2 px-4" style="border-radius: 6px;">Back</a>
                <a href="hr_edit_profile.php" class="btn btn-primary shadow-sm px-4" style="border-radius: 6px;">
