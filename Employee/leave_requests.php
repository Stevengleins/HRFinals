                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="date" class="form-control" id="start_date" onchange="updateDateLimits()" required>
                            </div>
                            <div class="col-md-6 form-group">
                ...
                <div class="table-responsive">
                  <table class="table table-hover table-striped m-0 text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                          <td class="align-middle"><?php echo htmlspecialchars($row['leave_type']); ?></td>
                          ...
                          <td class="align-middle text-left" style="max-width: 200px;">
                              <?php if($row['status'] == 'Rejected' && !empty($row['admin_remarks'])): ?>
                                  <small class="text-danger font-weight-bold">
                                      <i class="fas fa-info-circle"></i> <?php echo htmlspecialchars($row['admin_remarks']); ?>
                                  </small>
                              <?php else: ?>
...
<script>
  ...
  const leaveBalances = {
      ...
      'Paternity/Maternity Leave': <?php echo $pm_left; ?>,
  ...
  function updateDateLimits() {
      ...
      // Clear end date if they change the leave type or start date
      endDateInput.value = '';
      ...
      if (leaveType && startDateInput.value) {
          ...
          // If there is a limit, set the maximum selectable date
          if (maxDaysAllowed !== 999) {
              let startDateObj = new Date(startDateInput.value);
              // Subtract 1 because selecting the same day counts as 1 day
