...
<body class="hold-transition login-page m-0" style="background: url('YOUR_BACKGROUND_IMAGE_URL_HERE.jpg') no-repeat center center / cover; overflow: hidden; font-family: 'Source Sans Pro', sans-serif;">

  <div class="position-absolute w-100 h-100" style="background: rgba(0, 0, 0, 0.4); z-index: 0; top: 0; left: 0;"></div>

  <div class="position-absolute rounded-circle" style="width: 300px; height: 300px; background: #726969; top: -100px; right: -100px; z-index: 0;"></div>
  <div class="position-absolute rounded-circle" style="width: 350px; height: 350px; background: #726969; bottom: -150px; left: -150px; z-index: 0;"></div>

  <div class="container bg-white shadow-lg p-0 rounded overflow-hidden mt-5" style="max-width: 1000px; height: 550px; z-index: 1; position: relative;">
    <div class="row m-0 h-100">
      ...
      <div class="col-md-7 d-flex flex-column justify-content-center p-5">
        ...
        <div class="d-flex align-items-center mb-5">
          ...
          <h4 class="m-0 font-weight-bold">WORK<span class="font-weight-normal">FORCE</span></h4>
        </div>
        ...
        <div id="loginCarousel" class="carousel slide h-100 w-100" data-ride="carousel" data-interval="3000">
          ...
          <div class="carousel-inner h-100 w-100">
            ...
            <div class="carousel-item active h-100 w-100">
              <img src="YOUR_CAROUSEL_IMAGE_1.jpg" class="d-block h-100 w-100" style="object-fit: cover;" alt="Slide 1">
            ...
            <div class="carousel-item h-100 w-100">
              <img src="YOUR_CAROUSEL_IMAGE_2.jpg" class="d-block h-100 w-100" style="object-fit: cover;" alt="Slide 2">
              <div class="carousel-caption d-none d-md-block" style="background: rgba(0,0,0,0.5); border-radius: 8px;">
            ...
            <div class="carousel-item h-100 w-100">
              <img src="YOUR_CAROUSEL_IMAGE_3.jpg" class="d-block h-100 w-100" style="object-fit: cover;" alt="Slide 3">
              <div class="carousel-caption d-none d-md-block" style="background: rgba(0,0,0,0.5); border-radius: 8px;">
